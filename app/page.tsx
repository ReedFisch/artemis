        ...
        <div className="sticky top-0 h-[100svh] w-full overflow-hidden flex items-center justify-center bg-[#05070B]">
          ...
          <div className="hidden md:flex absolute bottom-16 left-1/2 -translate-x-1/2 z-30 pointer-events-auto cta-glow-wrap" style={{ perspective: '800px' }}>
            ...
            >
              ...
              <span className="relative z-10 text-lg">Support Now</span>
            </a>
          </div>
            ...
            <div id="timeline" className={isMobile ? "w-full px-6 pt-12 pb-4 relative z-10" : "w-[220vw] h-full relative z-10 overflow-hidden"}>
              ...
              {isMobile ? (
                ...
                <>
                  ...
                  <span className="absolute top-[6%] left-[76vw] text-[18vw] font-black text-white/[0.02] leading-none pointer-events-none select-none z-0" style={{ fontFamily: 'var(--font-display)' }}>25</span>
                  ...
                  <span className="absolute top-[6%] left-[144vw] text-[18vw] font-black text-white/[0.02] leading-none pointer-events-none select-none z-0" style={{ fontFamily: 'var(--font-display)' }}>26</span>
